<section class="sidebar bg-blue-200 text-gray-700 w-64 shadow-2xl px-1 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out z-50">
    ...
    <nav>
        ...
        <x-navbar.button href="/workspaces">Locais de Trabalho</x-navbar.button>
        @auth
